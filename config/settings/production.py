...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["api.rrqq.me"])
...
# DEFAULT_FROM_EMAIL = env("DJANGO_DEFAULT_FROM_EMAIL", default="veterinaria back<noreply@api.rrqq.me>")
# SERVER_EMAIL = env(
...
# EMAIL_HOST_USER = env.int("EMAIL_HOST_USER")
