...
# pagination
from veterinaria_api.api.pagination import NotificacionPagination

# Serializers
from veterinaria_api.api.serializers import (
    CitaModelSerializer,
...
class UserChangePassword(APIView):
    def post(self, request):
        serializer = UserChaguePasswordSerializer(
...
class MascotaModelViewSet(ReadOnlyModelViewSet):
    ...
    def historias(self, request, pk, *args, **kwargs):
        if request.method == "POST":
            data = request.data
            data["mascota_id"] = pk
            serializer = HistorialModelSerializer(
